...
def main():
    ...
    # parser.add_argument('prototxt',default = r'/media/st/DATA01/Projects/MXNet2Caffe_home/model_caffe/'
    #                                          r'deploy.prototxt', help='The prototxt filename')
    # parser.add_argument('caffemodel',default = r'/media/st/DATA01/Projects/MXNet2Caffe_home/model_caffe/'
    #                                            r'residual.caffemodel', help='The binary caffemodel filename')
    # parser.add_argument('save_model_name',default = r'tmp', help='The name of the output model prefix')
    #
    ...
    prototxt= r'/media/st/DATA01/Projects/MXNet2Caffe_home/model_caffe/test_deploy.prototxt'
    caffemodel =  r'/media/st/DATA01/Projects/MXNet2Caffe_home/model_caffe/test_model.caffemodel'
    save_model_name = r'tmp'
    convert_model(prototxt, caffemodel, save_model_name)
    print('Saved model successfully to {}'.format(save_model_name))
